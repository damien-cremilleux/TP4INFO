 ...
 * 
 */
package robotG.resource.robot.launch;
...
public class RobotLaunchConfigurationHelper {
	...
	public static class SystemOutInterpreter extends robotG.resource.robot.util.AbstractRobotInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, robotG.resource.robot.util.AbstractRobotInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final robotG.resource.robot.debug.RobotDebuggableInterpreter<ResultType, ContextType> interpreter = new robotG.resource.robot.debug.RobotDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		robotG.resource.robot.debug.RobotDebuggerListener<ResultType, ContextType> debugListener = new robotG.resource.robot.debug.RobotDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		robotG.resource.robot.debug.RobotDebugProcess process = new robotG.resource.robot.debug.RobotDebugProcess(launch);
		launch.addDebugTarget(new robotG.resource.robot.debug.RobotDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(robotG.resource.robot.launch.RobotLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return robotG.resource.robot.util.RobotResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, robotG.resource.robot.mopp.RobotPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
