 ...
 * given name.
 */
public class RobotReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements robotG.resource.robot.IRobotReferenceCache {
	...
	private robotG.resource.robot.IRobotNameProvider nameProvider;
	
	public RobotReferenceCache(robotG.resource.robot.IRobotNameProvider nameProvider) {
		super();
