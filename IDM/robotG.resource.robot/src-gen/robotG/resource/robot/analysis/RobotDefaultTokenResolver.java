 ...
 */
public class RobotDefaultTokenResolver implements robotG.resource.robot.IRobotTokenResolver {
	 ...
	 */
	public RobotDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public RobotDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, robotG.resource.robot.IRobotTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : robotG.resource.robot.grammar.RobotGrammarInformationProvider.INSTANCE.getKeywords()) {
