...
public class RobotBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	 ...
	 */
	public final static String BUILDER_ID = "robotG.resource.robot.builder";
	
	private robotG.resource.robot.IRobotBuilder defaultBuilder = new robotG.resource.robot.mopp.RobotBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		robotG.resource.robot.IRobotBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			robotG.resource.robot.mopp.RobotResource customResource = (robotG.resource.robot.mopp.RobotResource) resourceSet.getResource(uri, true);
			new robotG.resource.robot.mopp.RobotMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public robotG.resource.robot.IRobotBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new robotG.resource.robot.mopp.RobotMarkerHelper().getMarkerID(robotG.resource.robot.RobotEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		robotG.resource.robot.mopp.RobotTaskItemBuilder taskItemBuilder = new robotG.resource.robot.mopp.RobotTaskItemBuilder();
		new robotG.resource.robot.mopp.RobotMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new robotG.resource.robot.mopp.RobotMetaInformation().getSyntaxName())) {
