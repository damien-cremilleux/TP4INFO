 ...
 */
public class RobotPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "robotG.resource.robot";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, RobotPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, RobotPlugin.PLUGIN_ID, message);
		}
		final RobotPlugin pluginInstance = RobotPlugin.getDefault();
