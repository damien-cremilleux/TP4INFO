...
public class RobotANTLRTextToken extends robotG.resource.robot.mopp.RobotTextToken {
	
	private final static robotG.resource.robot.IRobotMetaInformation metaInformation = new robotG.resource.robot.mopp.RobotMetaInformation();
	
	public RobotANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
