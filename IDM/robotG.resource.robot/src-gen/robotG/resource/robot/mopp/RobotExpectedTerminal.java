 ...
 */
public class RobotExpectedTerminal {
	...
	private robotG.resource.robot.IRobotExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private robotG.resource.robot.grammar.RobotContainmentTrace containmentTrace;
	
	public RobotExpectedTerminal(org.eclipse.emf.ecore.EObject container, robotG.resource.robot.IRobotExpectedElement terminal, int followSetID, robotG.resource.robot.grammar.RobotContainmentTrace containmentTrace) {
		super();
	...
	public robotG.resource.robot.IRobotExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		RobotExpectedTerminal otherExpectedTerminal = (RobotExpectedTerminal) o;
	...
	public robotG.resource.robot.grammar.RobotContainmentTrace getContainmentTrace() {
