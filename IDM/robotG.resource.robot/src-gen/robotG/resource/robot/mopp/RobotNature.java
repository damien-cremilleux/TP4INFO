...
public class RobotNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "robotG.resource.robot.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {robotG.resource.robot.mopp.RobotBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(robotG.resource.robot.mopp.RobotBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
