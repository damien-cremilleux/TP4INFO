...
/**
 * RobotLayoutInformation objects are used to store layout information that is
 ...
 * RobotLayoutInformations are aggregated in LayoutInformationAdapters. One
 * RobotLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class RobotLayoutInformation {
	 ...
	 */
	private final robotG.resource.robot.grammar.RobotSyntaxElement syntaxElement;
	...
	public RobotLayoutInformation(robotG.resource.robot.grammar.RobotSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public robotG.resource.robot.grammar.RobotSyntaxElement getSyntaxElement() {
