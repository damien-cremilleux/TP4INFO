...
/**
 * A RobotLayoutInformationAdapter is used to store layout information that is
 ...
 * RobotLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class RobotLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<robotG.resource.robot.mopp.RobotLayoutInformation> layoutInformations = new java.util.ArrayList<robotG.resource.robot.mopp.RobotLayoutInformation>();
	...
	public java.util.List<robotG.resource.robot.mopp.RobotLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(robotG.resource.robot.mopp.RobotLayoutInformation layoutInformation) {
