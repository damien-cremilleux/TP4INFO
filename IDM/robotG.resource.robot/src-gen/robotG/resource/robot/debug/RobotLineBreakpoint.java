...
public class RobotLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	...
	private static final String LINE_BREAKPOINT_MARKER_ID = "robotG.resource.robot.debug.lineBreakpoint.marker";
	...
	public String getModelIdentifier() {
		return robotG.resource.robot.mopp.RobotPlugin.DEBUG_MODEL_ID;
	}
	
	public void install(robotG.resource.robot.debug.RobotDebugTarget target) {
		try {
	...
	public void remove(robotG.resource.robot.debug.RobotDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
