...
public class RobotStackFrame extends robotG.resource.robot.debug.RobotDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private robotG.resource.robot.debug.RobotDebugTarget target;
	private String name;
	private int id;
	...
	public RobotStackFrame(robotG.resource.robot.debug.RobotDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = robotG.resource.robot.util.RobotStringUtil.decode(data, ',');
	...
	private robotG.resource.robot.debug.RobotDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		robotG.resource.robot.debug.RobotStackFrame other = (robotG.resource.robot.debug.RobotStackFrame) obj;
		if (name == null) {
