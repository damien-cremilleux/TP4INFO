 ...
 * resolver
 */
public interface IRobotReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends robotG.resource.robot.IRobotConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, robotG.resource.robot.IRobotReferenceResolveResult<ReferenceType> result);
