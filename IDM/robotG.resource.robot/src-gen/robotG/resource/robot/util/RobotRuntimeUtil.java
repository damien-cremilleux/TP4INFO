...
public class RobotRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			robotG.resource.robot.mopp.RobotPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			robotG.resource.robot.mopp.RobotPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
