...
public class RobotStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, robotG.resource.robot.IRobotFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, robotG.resource.robot.IRobotFunction1<String, T> toStringFunction) {
