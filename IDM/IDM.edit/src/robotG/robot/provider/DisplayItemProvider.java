...
/**
 * This is the item provider adapter for a {@link robotG.robot.Display} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisplayItemProvider
	extends CommandeRobotItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_msg_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_msg_feature", "_UI_Display_type"),
				 RobotPackage.Literals.DISPLAY__MSG,
				 true,
				 false,
				 false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_duration_feature", "_UI_Display_type"),
				 RobotPackage.Literals.DISPLAY__DURATION,
				 true,
				 false,
				 false,
	...
	protected void addLinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_line_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_line_feature", "_UI_Display_type"),
				 RobotPackage.Literals.DISPLAY__LINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addColPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_col_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_col_feature", "_UI_Display_type"),
				 RobotPackage.Literals.DISPLAY__COL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Display)object).getMsg();
