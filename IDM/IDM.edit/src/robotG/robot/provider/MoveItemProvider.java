...
/**
 * This is the item provider adapter for a {@link robotG.robot.Move} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Move_power_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Move_power_feature", "_UI_Move_type"),
				 RobotPackage.Literals.MOVE__POWER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Move_type") + " " + move.getPower();
	}
