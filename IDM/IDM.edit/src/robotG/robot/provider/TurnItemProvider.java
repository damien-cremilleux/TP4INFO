...
/**
 * This is the item provider adapter for a {@link robotG.robot.Turn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TurnItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Turn_power_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Turn_power_feature", "_UI_Turn_type"),
				 RobotPackage.Literals.TURN__POWER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobotPackage.Literals.TURN__ANGLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Turn_type") + " " + turn.getPower();
	}
