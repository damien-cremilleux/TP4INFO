...
public class RobotLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(robotG.resource.robot.mopp.RobotPlugin.DEBUG_MODEL_ID);
			...
			robotG.resource.robot.debug.RobotLineBreakpoint lineBreakpoint = new robotG.resource.robot.debug.RobotLineBreakpoint(resource, lineNumber + 1);
