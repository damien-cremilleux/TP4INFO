...
public class RobotDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public RobotDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return robotG.resource.robot.ui.RobotUIPlugin.EDITOR_ID;
		}
		return null;
	}
