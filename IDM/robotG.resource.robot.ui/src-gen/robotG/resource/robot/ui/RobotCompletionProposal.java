 ...
 */
public class RobotCompletionProposal implements java.lang.Comparable<RobotCompletionProposal> {
	 ...
	 */
	private robotG.resource.robot.mopp.RobotExpectedTerminal expectedTerminal;
	...
	public RobotCompletionProposal(robotG.resource.robot.mopp.RobotExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public RobotCompletionProposal(robotG.resource.robot.mopp.RobotExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public RobotCompletionProposal(robotG.resource.robot.mopp.RobotExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public robotG.resource.robot.mopp.RobotExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof RobotCompletionProposal) {
			RobotCompletionProposal other = (RobotCompletionProposal) object;
	...
	public int compareTo(RobotCompletionProposal object) {
		if (object instanceof RobotCompletionProposal) {
			RobotCompletionProposal other = (RobotCompletionProposal) object;
