...
public class RobotPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new robotG.resource.robot.mopp.RobotMetaInformation().getSyntaxName());
	}
