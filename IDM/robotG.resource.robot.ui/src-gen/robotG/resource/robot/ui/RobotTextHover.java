 ...
 */
public class RobotTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private robotG.resource.robot.IRobotHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final robotG.resource.robot.ui.RobotBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(robotG.resource.robot.ui.RobotBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			robotG.resource.robot.ui.RobotDocBrowserInformationControlInput infoInput = (robotG.resource.robot.ui.RobotDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					robotG.resource.robot.ui.RobotHyperlink hyperlink = new robotG.resource.robot.ui.RobotHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (robotG.resource.robot.ui.RobotBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				robotG.resource.robot.ui.RobotBrowserInformationControl iControl = new robotG.resource.robot.ui.RobotBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof robotG.resource.robot.ui.RobotDocBrowserInformationControlInput) {
							robotG.resource.robot.ui.RobotDocBrowserInformationControlInput input = (robotG.resource.robot.ui.RobotDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (robotG.resource.robot.ui.RobotBrowserInformationControl.isAvailable(parent)) {
				robotG.resource.robot.ui.RobotBrowserInformationControl iControl = new robotG.resource.robot.ui.RobotBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public RobotTextHover(robotG.resource.robot.IRobotResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new robotG.resource.robot.ui.RobotUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((robotG.resource.robot.ui.RobotDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private robotG.resource.robot.ui.RobotDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private robotG.resource.robot.ui.RobotDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, robotG.resource.robot.ui.RobotDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				robotG.resource.robot.ui.RobotHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			robotG.resource.robot.ui.RobotHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			robotG.resource.robot.ui.RobotHTMLPrinter.insertPageProlog(buffer, 0, robotG.resource.robot.ui.RobotTextHover.getStyleSheet());
			robotG.resource.robot.ui.RobotHTMLPrinter.addPageEpilog(buffer);
			return new robotG.resource.robot.ui.RobotDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = robotG.resource.robot.ui.RobotHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(robotG.resource.robot.ui.RobotUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return robotG.resource.robot.util.RobotStreamUtil.getContent(styleSheetURL.openStream());
