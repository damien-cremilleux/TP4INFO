 ...
 * a specified depth.
 */
public class RobotOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public RobotOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = robotG.resource.robot.util.RobotStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof robotG.resource.robot.ui.RobotEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			robotG.resource.robot.mopp.RobotPlugin.logError("Exception while refreshing outline view", e);
		}
	}
