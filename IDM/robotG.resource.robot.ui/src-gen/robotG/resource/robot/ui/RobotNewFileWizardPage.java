 ...
 */
public class RobotNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public RobotNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new robot file");
