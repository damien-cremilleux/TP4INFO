 ...
 */
public class RobotNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new robotG.resource.robot.mopp.RobotMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("robotG.resource.robot.ui");
							...
							String natureID = robotG.resource.robot.mopp.RobotNature.NATURE_ID;
							...
							for (String builderID : robotG.resource.robot.mopp.RobotNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								robotG.resource.robot.mopp.RobotMetaInformation info = new robotG.resource.robot.mopp.RobotMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = robotG.resource.robot.ui.RobotUIPlugin.getDefault().getBundle();
