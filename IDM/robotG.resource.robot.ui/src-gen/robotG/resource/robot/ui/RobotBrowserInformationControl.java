 ...
 * @since 3.2
 */
public class RobotBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private robotG.resource.robot.ui.RobotDocBrowserInformationControlInput fInput;
	 ...
	 */
	public RobotBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public RobotBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public RobotBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof robotG.resource.robot.ui.RobotDocBrowserInformationControlInput);
		...
		fInput= (robotG.resource.robot.ui.RobotDocBrowserInformationControlInput) input;
		...
		robotG.resource.robot.ui.RobotHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = robotG.resource.robot.ui.RobotHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public robotG.resource.robot.ui.RobotDocBrowserInformationControlInput getInput() {
		return fInput;
	}
