 ...
 */
public class RobotHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public RobotHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				robotG.resource.robot.mopp.RobotPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
