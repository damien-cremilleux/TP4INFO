 ...
 */
public class RobotCodeFoldingManager {
	
	private class FoldingUpdateListener implements robotG.resource.robot.IRobotBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(robotG.resource.robot.ui.RobotEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof robotG.resource.robot.ui.RobotEditor) {
				robotG.resource.robot.ui.RobotEditor editor = (robotG.resource.robot.ui.RobotEditor) workbenchPart;
	...
	protected robotG.resource.robot.ui.RobotEditor editor;
	 ...
	 */
	public RobotCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,robotG.resource.robot.ui.RobotEditor textEditor) {
	...
	private void addCloseListener(final robotG.resource.robot.ui.RobotEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			robotG.resource.robot.ui.RobotUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		robotG.resource.robot.IRobotTextResource textResource = (robotG.resource.robot.IRobotTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
