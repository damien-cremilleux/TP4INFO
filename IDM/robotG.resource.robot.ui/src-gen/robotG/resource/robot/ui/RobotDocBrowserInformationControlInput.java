 ...
 * olInput</code>.
 */
public class RobotDocBrowserInformationControlInput {
	
	private final RobotDocBrowserInformationControlInput fPrevious;
	private RobotDocBrowserInformationControlInput fNext;
	 ...
	 */
	public RobotDocBrowserInformationControlInput(RobotDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public RobotDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public RobotDocBrowserInformationControlInput getNext() {
		return fNext;
	}
