 ...
 */
public class RobotSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public RobotSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = robotG.resource.robot.ui.RobotSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, robotG.resource.robot.ui.RobotSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = robotG.resource.robot.ui.RobotSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, robotG.resource.robot.ui.RobotSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = robotG.resource.robot.ui.RobotSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, robotG.resource.robot.ui.RobotSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = robotG.resource.robot.ui.RobotSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, robotG.resource.robot.ui.RobotSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = robotG.resource.robot.ui.RobotSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, robotG.resource.robot.ui.RobotSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = robotG.resource.robot.ui.RobotSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, robotG.resource.robot.ui.RobotSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		robotG.resource.robot.ui.RobotPixelConverter pixelConverter = new robotG.resource.robot.ui.RobotPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof robotG.resource.robot.ui.RobotEditor) {
			robotG.resource.robot.ui.RobotEditor emfTextEditor = (robotG.resource.robot.ui.RobotEditor) editor;
