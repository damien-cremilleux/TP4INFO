...
public class RobotPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof robotG.resource.robot.ui.RobotEObjectSelection) {
			final robotG.resource.robot.ui.RobotEObjectSelection selection = (robotG.resource.robot.ui.RobotEObjectSelection) iSelection;
