 ...
 */
public class RobotLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new robotG.resource.robot.mopp.RobotMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(robotG.resource.robot.launch.RobotLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			robotG.resource.robot.mopp.RobotPlugin.logError("Exception while launching selection", e);
		}
	}
