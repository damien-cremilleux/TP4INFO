...
expr:
 ...
 | LET REC IDENT COLON typ EQUAL expr IN expr { Ml_letrec($3, $5, fst $7, fst $9) , StrSet.union (snd $7) (StrSet.remove $3 (snd $9)) }

simple_expr:
 | INT { Ml_int $1,StrSet.empty }
 | bool { Ml_bool $1,StrSet.empty }
 | LEFT_PAREN LEFT_BRACKET RIGHT_BRACKET COLON typ RIGHT_PAREN { Ml_nil $5, StrSet.empty }
...
pattern:
 | LEFT_PAREN IDENT COLON typ RIGHT_PAREN { Ml_pattern_var ($2,$4) , StrSet.singleton $2} 
 ...
 | LEFT_PAREN LEFT_BRACKET RIGHT_BRACKET COLON typ RIGHT_PAREN { Ml_pattern_nil $5 , StrSet.empty }
...
application:
 | simple_expr_or_parenthesized_expr simple_expr_or_parenthesized_expr application_next { fst $1 :: fst $2 :: fst $3,
                                                                                          StrSet.union (snd $1) (StrSet.union (snd $2) (snd $3))
                                                                                        }
