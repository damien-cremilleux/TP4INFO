...
public class IntEvt {
	...
	private int val;
	private Thread _me;	// le thread qui a cree l'evenement
	...
	public synchronized void  write(int i){
		System.out.println("Tentative d'ecriture");
		if( _me ==  Thread.currentThread()){

			if(!ecrit){
				val = i;
				ecrit = true;
				System.out.println("Ecriture realisee");
				this.notifyAll();


			}else
				System.out.println("Ecriture deja faite");
		}else
